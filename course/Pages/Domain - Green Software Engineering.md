...
2.  **Energy Profiling of Design Patterns:** Compare the energy consumption of *REST* vs. *gRPC* for the same workload using tools like *Scaphandre*.
    * *Quality Criteria:* Energy-per-Transaction (Joules) & CPU Wattage variance.
    * *Source:* [Principles of Green Software Engineering](https://principles.green/)
3.  **Hardware Durability & Thin-Client Design:** Prototype a "Thin-Client" that runs performantly on 8-year-old hardware to extend its lifecycle and reduce e-waste.
    * *Quality Criteria:* Minimum Hardware Specification & Resource Footprint Reduction.
    * *Source:* [Low-Tech Magazine: Sustainable Design](https://solar.lowtechmagazine.com/about/the-solar-website/)
4.  **Sustainable Data Engineering:** Implement aggressive TTL policies and efficient serialization (Avro/Protobuf) to reduce storage and transmission energy.
    * *Quality Criteria:* Network Egress Volume & Storage Energy Efficiency.
    * *Source:* [Green Software Podcast](https://greensoftware.foundation/articles/podcast)